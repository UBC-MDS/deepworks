...
AFFIRMATIONS = [
    ...
    {
        "text": "{name}, small commits still move the project forward.",
        "category": "motivation",
        "energy": "low",
    },
    {
        "text": "Rest is part of the process, {name}.",
        "category": "motivation",
        "energy": "low",
    },
    {
        "text": "{name}, every bug fixed is progress.",
        "category": "motivation",
        "energy": "low",
    },
    # Motivation - Medium Energy
    {
        "text": "{name}, you have the skills to solve this.",
        "category": "motivation",
        "energy": "medium",
    },
    {
        "text": "Your code makes a difference, {name}.",
        "category": "motivation",
        "energy": "medium",
    },
    {
        "text": "{name}, you've debugged harder problems than this.",
        "category": "motivation",
        "energy": "medium",
    },
    # Motivation - High Energy
    {
        "text": "{name}, you're on fire! Ship that feature!",
        "category": "motivation",
        "energy": "high",
    },
    {
        "text": "Channel that energy into clean code, {name}!",
        "category": "motivation",
        "energy": "high",
    },
    # Confidence
    ...
    {
        "text": "Trust your debugging instincts, {name}.",
        "category": "confidence",
        "energy": "medium",
    },
    {
        "text": "{name}, your unique perspective makes the team stronger.",
        "category": "confidence",
        "energy": "medium",
    },
    ...
    # Persistence
    {
        "text": "{name}, even senior devs Google things.",
        "category": "persistence",
        "energy": "low",
    },
    {
        "text": "The bug will surrender eventually, {name}.",
        "category": "persistence",
        "energy": "medium",
    },
    {
        "text": "{name}, stuck is temporary. Keep digging.",
        "category": "persistence",
        "energy": "medium",
    },
    {
        "text": "Persistence beats talent, {name}. Keep going!",
        "category": "persistence",
        "energy": "high",
    },
    # Self-care
    {
        "text": "{name}, it's okay to step away from the screen.",
        "category": "self-care",
        "energy": "low",
    },
    {
        "text": "Your worth isn't measured in commits, {name}.",
        "category": "self-care",
        "energy": "low",
    },
    {
        "text": "{name}, take a break. The code will wait.",
        "category": "self-care",
        "energy": "medium",
    },
    # Growth
    {
        "text": "{name}, every error is a learning opportunity.",
        "category": "growth",
        "energy": "low",
    },
    {
        "text": "You're a better developer than you were yesterday, {name}.",
        "category": "growth",
        "energy": "medium",
    },
    {
        "text": "{name}, embrace the struggle. That's where growth happens.",
        "category": "growth",
        "energy": "medium",
    },
    {
        "text": "Level up, {name}! Challenge accepted!",
        "category": "growth",
        "energy": "high",
    },
]
...
def _validate_inputs(
    name: str, mood: str, energy: int, category: Optional[str], seed: Optional[int]
) -> None:
    """
...
def _weight_affirmations(
    preferred_categories: list[str], energy_cat: str
...
def _calculate_alignment(
    selected: dict, preferred_categories: list[str], energy_cat: str
) -> float:
    """
